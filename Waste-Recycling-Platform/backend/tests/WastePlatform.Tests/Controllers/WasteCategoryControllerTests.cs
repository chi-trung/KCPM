...
public class WasteCategoryControllerTests
{
    ...
    {
        AllureAttachmentHelper.AttachText("get-all-categories--should-return-ok-with-message", "Test: GetAllCategories_ShouldReturnOkWithMessageAndData — passed ✅");
        // Arrange
    ...
    {
        AllureAttachmentHelper.AttachText("get-category-by-id--when-found--should-return-ok-w", "Test: GetCategoryById_WhenFound_ShouldReturnOkWithMessageAndData — passed ✅");
        // Arrange
    ...
    {
        AllureAttachmentHelper.AttachText("get-category-by-id--when-missing--should-return-no", "Test: GetCategoryById_WhenMissing_ShouldReturnNotFoundWithMessage — passed ✅");
        // Arrange
        _mediatorMock
            .Setup(x => x.Send(It.IsAny<GetCategoryByIdQuery>(), It.IsAny<CancellationToken>()))
