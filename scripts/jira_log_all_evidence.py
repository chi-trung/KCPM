...
ALL_EVIDENCE = {
    ...
    "KIEM-11": {
        ...
        "i": [
            ...
            [b("Newman CI:"), t(" postman-smoke.yml runs on every push + PR")],
        ],
        "c": [
            "232aabb3 feat: add Jira logging step to Postman workflows",
            "c42c402d fix: add allure reporter to postman-smoke.yml",
