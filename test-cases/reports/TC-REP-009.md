...
- Đã bổ sung bộ xUnit test cho module `WasteCategory` ở thư mục `Waste-Recycling-Platform/backend/tests/WastePlatform.Tests` và đã chạy pass.
